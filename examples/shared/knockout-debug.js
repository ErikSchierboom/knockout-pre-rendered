    ...
    (function(factory) {
        ...
        notifySubscribers: function(valueToNotify, event) {
          ...
          if (this.hasSubscriptionsForEvent(event)) {
            try {
              ...
              for (
                var a = this._subscriptions[event].slice(0),
                  i = 0,
                  subscription;
                (subscription = a[i]);
                ++i
      ...
      ko.computed = ko.dependentObservable = function(
        ...
        function disposeAllSubscriptionsToDependencies() {
          ko.utils.objectForEach(_subscriptionsToDependencies, function(
            id,
            subscription
          ) {
          ...
          if (isSleeping) {
            ...
            try {
              ...
              try {
                ...
                if (disposalCount) {
                  ko.utils.objectForEach(disposalCandidates, function(
                    id,
                    toDispose
                  ) {
                    toDispose.dispose();
      ...
      ko.bindingHandlers["options"] = {
        ...
        update: function(element, valueAccessor, allBindings) {
          ...
          var previousScrollTop =
            !selectWasPreviouslyEmpty && element.multiple
              ? element.scrollTop
              : null;
